...
3. Isolate the failing branch of the unknown mutant.
  ...
  - Make sure `assigndump.smt2` is created and that it does not branch. (`z3 assigndump.smt2 trace=true tactic.default_tactic=smt smt.reduce_assertions=false` should create a z3.log without any decisons)
